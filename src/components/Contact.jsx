      ...
      <div className="contact__content">
        ...
        <div className="contact__para">
          ...
          <div className="contact__para-content">
            ...
            <button className="contact__content-icon phone" style={{"marginLeft":"0"}}>
              <a
                className="icon-link"
                href="tel:+918840048405"
              >
                <PhoneIcon />
              </a>
            </button>
            <button className="contact__content-icon mail">
              <a
                className="icon-link"
                href="mailto:anuraggoel27@gmail.com"
              >
                <MailIcon />
              </a>
            </button>
            ...
            <button className="contact__content-icon linkedin">
              <a href="https://www.linkedin.com/in/anurag-goel-481894196/" className="icon-link">
                <LinkedInIcon />
              </a>
            </button>
            <button className="contact__content-icon facebook">
              <a href="https://www.facebook.com/anuragdgr8" className="icon-link">
                <FacebookIcon />
              </a>
            </button>
